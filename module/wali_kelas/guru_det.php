          ...
          <div class="row">
                <div class="col-lg-12">
					<h3 class="page-header"><strong>Input wali_kelas</strong></h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Edit Data wali_kelas
                        </div>
                        <div class="panel-body">
                            <div class="row">
<?php                            
                            	$sql=mysql_query("select * from wali_kelas where nip='$_SESSION[idu]'");
								$rs=mysql_fetch_array($sql);
?>
                                    <form method="post" role="form" action="././module/simpan.php?act=wali_kelas_det">
