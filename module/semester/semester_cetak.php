...
$pdf->Cell(21,0.7,"Data Semester",0,1,'C');
...
$pdf->Cell(5, 0.8, 'Semester', TRUE, 0, 'C');
$pdf->Cell(3, 0.8, 'Tahun', TRUE, 0, 'C');
$pdf->Cell(4, 0.8, 'Tanggal Awal', TRUE, 0, 'C');
$pdf->Cell(4, 0.8, 'Tanggal Akhir', TRUE, 1, 'C');
...
while($data=mysqli_fetch_array($query)){
	$pdf->SetX(2);
	$pdf->Cell(1.3, 0.8, $no, TRUE, 0, 'C');  // CellCell($w, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=false, $link='')
	$pdf->Cell(5, 0.8, $data['semester'], TRUE, 0, 'C');
	$pdf->Cell(3, 0.8, $data['tahun'], TRUE, 0, 'C');
	$pdf->Cell(4, 0.8, $data['tgl_awal'], TRUE, 0, 'C');
	$pdf->Cell(4, 0.8, $data['tgl_akhir'], TRUE, 1, 'C');
	$no++;
}
