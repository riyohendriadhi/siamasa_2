...
<div class="row" style="margin:10px" >
    <div id="">
        <ol class="breadcrumb">
            <li class="link_breadcrumb" href="#">Rekap Absensi > Absensi Persiswa (User Wali murid) </li>
        </ol>
    </div>
</div>
<!-- /.row -->
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <!-- <div class="row"> -->
                    <form method="post" action="?module=rekap_persiswa_walimurid" class="form-horizontal" role="form">
