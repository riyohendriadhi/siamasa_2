...
?>                                        <tr class="odd gradeX">
                                        ...
                                        <td class="text-center"><a href="./././media.php?module=input_user&act=edit_user&idu=<?php echo $rs['idu'] ?>"><button type="button" class="btn btn-info"><span class="glyphicon glyphicon-pencil"></button>
 <?php 	if($_SESSION['level']!="admin_guru"){ ?>  
 <a href="././module/simpan.php?act=hapus_user&idu=<?php echo $rs['idu'] ?>"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></button></a></td>
<?php } ?>
